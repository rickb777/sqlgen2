...
func (tbl DUserTable) doQueryOne(query string, args ...interface{}) (*User, error) {
...
// Note that this applies ReplaceTableName to the query string.
func (tbl DUserTable) QueryOneNullString(query string, args ...interface{}) (sql.NullString, error) {
...
// such like. If the query selected many rows, only the first is returned; the rest are discarded.
// Note that this applies ReplaceTableName to the query string.
func (tbl DUserTable) QueryOneNullInt64(query string, args ...interface{}) (sql.NullInt64, error) {
...
// such like. If the query selected many rows, only the first is returned; the rest are discarded.
// Note that this applies ReplaceTableName to the query string.
func (tbl DUserTable) QueryOneNullFloat64(query string, args ...interface{}) (sql.NullFloat64, error) {
