...
type PUserQueryer interface {
	...
	Transact(txOptions *pgx.TxOptions, fn func(PUserQueryer) error) error
...
func (tbl PUserTable) Transact(txOptions *pgx.TxOptions, fn func(PUserQueryer) error) error {
	var err error
	if tbl.IsTx() {
