...
type AUserQueryer interface {
	...
	Transact(txOptions *pgx.TxOptions, fn func(AUserQueryer) error) error
...
func (tbl AUserTable) Transact(txOptions *pgx.TxOptions, fn func(AUserQueryer) error) error {
	var err error
	if tbl.IsTx() {
