...
func (tbl HookTable) quotedNameW(w driver.StringWriter) {
...
func constructHookTableInsert(tbl HookTable, w io.StringWriter, v *Hook, withPk bool) (s []interface{}, err error) {
	q := tbl.Dialect().Quoter()
...
func constructHookTableUpdate(tbl HookTable, w io.StringWriter, v *Hook) (s []interface{}, err error) {
	q := tbl.Dialect().Quoter()
	j := 1
