...
func checkForKeywords(name parse.LType, table *schema.TableDescription) {
	//for _, f := range table.Fields {
		//if sqlKeywords.Contains(strings.ToLower(f.SqlName)) {
		//	parse.DevInfo("checkForKeywords %s %+v\n", name, utter.Sdump(table))
		//	exit.Fail(5, "%s: error: column name %q is a reserved word.\n", name, f.SqlName)
		//}
	//}
}


// taken from a useful but not-authoritative source
// https://www.drupal.org/docs/develop/coding-standards/list-of-sql-reserved-words
// (without any containing dashes)

var sqlKeywords = code.NewStringSet(
	"a",
	"abort",
	"abs",
	"absolute",
